This project showcases an in-depth SQL-based exploration of a COVID-19 dataset. The goal is to extract meaningful insights and demonstrate advanced SQL skills through data cleaning and analysis.
